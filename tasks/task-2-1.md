...
- Add react-beautiful-dnd to package.json
- Install types for TypeScript support (@types/react-beautiful-dnd)
- Configure DragDropContext at the appropriate level
...
- Library should be installed in frontend directory only
